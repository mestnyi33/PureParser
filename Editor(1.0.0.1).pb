...
Procedure PC_Destroy()
  With ParsePBObject()
    ; Ищем идентификатор 
    Protected Identific$ = ","+#CRLF$+Space(Len("Global "))+\Object\Argument$+"=-1"
    ...
    If RegExID
      If ExamineRegularExpression(RegExID, *This\Content\Text$)
        While NextRegularExpressionMatch(RegExID)
          *This\get(ParsePBObject()\Window\Argument$)\Code("Code_Global")\Position = RegularExpressionMatchPosition(RegExID)
          Break
        Wend
      EndIf
    ...
    If RegExID
      ...
      ForEach ParsePBObject()
        If ParsePBObject()\Container 
          *This\get(ParsePBObject()\Object\Argument$)\Code("Code_Object")\Position - len
        EndIf
      Next
...
Procedure CO_Insert(*ThisParse.ParseStruct, Parent)
  ...
  With *ThisParse
    ...
    If \Type\Argument$ = "OpenWindow" Or \Type\Argument$ = "FormGadget"
    ...
    *This\get(*This\Window\Argument$)\Code("Code_Global")\Position + VariableLength
    ...
    Select \Type\Argument$
        Case "FormGadget"          : \Content\String$ = Handle$+"OpenWindow("+ID$+", "+\X\Argument$+", "+\Y\Argument$+", "+\Width\Argument$+", "+\Height\Argument$+", "+ Chr(34)+\Caption\Argument$+Chr(34)                            : If \Flag\Argument$ : \Content\String$ +", "+\Flag\Argument$ : EndIf
        Case "OpenWindow"          : \Content\String$ = Handle$+"OpenWindow("+ID$+", "+\X\Argument$+", "+\Y\Argument$+", "+\Width\Argument$+", "+\Height\Argument$+", "+ Chr(34)+\Caption\Argument$+Chr(34)                                                : If \Flag\Argument$ : \Content\String$ +", "+\Flag\Argument$ : EndIf: If \Param1\Argument$ : \Content\String$ +", "+\Param1\Argument$ : EndIf
...
Procedure CO_Create(Type$, X, Y, Parent=-1)
  ...
  With *This
    ...
    Select Type$
      Case "Form" : \Type\Argument$ = "FormGadget"
  ...
  DataSection
    Model:
    ;{
    Data.s "FormGadget","300","200","0","0","0","#PB_Canvas_Container"
...
Procedure FormGadget(Gadget, X,Y,Width,Height, Text$)
  ...
  BindGadgetEvent(Gadget, @FormCallBack())
...
Procedure CO_Open() ; Ok
  ...
  With *This
    ...
    Select \Type\Argument$
      Case "FormGadget"
        \Type\Argument$ = "CanvasGadget"
        \Type\Argument = #PB_GadgetType_Canvas
        \Flag\Argument|#PB_Canvas_Container
        
        \Object\Argument =  FormGadget        (#PB_Any, \X\Argument,\Y\Argument,\Width\Argument,\Height\Argument, \Caption\Argument$) 
    ...
    Select \Type\Argument$
      ...
      Case "FormGadget" 
        \Window\Argument$ = "WE"
        \Window\Argument = WE
        \Parent\Argument = \Object\Argument : \Container = \Type\Argument : \SubLevel = 1
    ...
    If IsGadget(\Object\Argument)
      ...
      UnbindEvent(#PB_Event_Gadget, @CO_Events(), \Window\Argument)
      BindEvent(#PB_Event_Gadget, @CO_Events(), \Window\Argument)
      
      UnbindEvent(#PB_Event_Create, @CO_Events(), \Window\Argument)
      BindEvent(#PB_Event_Create, @CO_Events(), \Window\Argument)
...
Procedure WE_Open(ParentID=0, Flag.i=#PB_Window_SystemMenu)
  If Not IsWindow(WE)
    ...
    WE_ScrollArea_0 = ScrollAreaGadget(#PB_Any, 0, 0, 150, 150, 900, 800) : CloseGadgetList()
        ...
        Case WE_Selecting
          ...
          Select EventType()
            Case #PB_EventType_RightClick    
              Transformation::PopupMenu(GetGadgetItemData(WE_Selecting, GetGadgetState(WE_Selecting)))
    ...
    Case #PB_Event_Menu ;- Menu(Event)
      ...
      Select EventMenu()
        ...
        Case WE_Menu_New ;- Event(_WE_Menu_New_)
          CO_Create("Form",30,30, WE_ScrollArea_0)
