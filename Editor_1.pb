...
Procedure WE_Code_Open(ParentID.i=0, Flag.i=#PB_Window_TitleBar|#PB_Window_SizeGadget|#PB_Window_Invisible)
  If IsWindow(WE_Code)
    SetActiveWindow(WE_Code)
    ProcedureReturn WE_Code
  EndIf
  
  Protected UseGadgetList = UseGadgetList(0)
  WE_Code = OpenWindow(#PB_Any, #PB_Ignore, #PB_Ignore, 800, 600, "(WE) - code", Flag, ParentID)
  SetWindowData(WE_Code, Scintilla::Gadget(#PB_Any, 0, 0, 0, 0))
...
Procedure WE_Code_Events(Event)
  Select Event
    ...
    Case #PB_Event_Gadget
      ...
      Select EventType()
        ...
        Case #PB_EventType_StatusChange
          ...
          For I=0 To CountGadgetItems(WE_Selecting)-1
            If Object = GetGadgetItemData(WE_Selecting, I) : SetGadgetState(WE_Selecting, I)
              PostEvent(#PB_Event_Gadget, WE, WE_Selecting, #PB_EventType_Change)
              Break
            EndIf
          Next  
  ...
  With *This
    ...
    If  *ThisParse
      ...
      If \Content\Text$=""
        ...
        \get(\get(Str(Parent))\Object\Argument$)\Code("Code_Object")\Position = 249+75 
      EndIf
      ...
      Else
        ...
        If *This\get(Str(ParsePBGadget()\Parent\Argument))\Object\Argument$
          ...
          *This\get(Str(ParsePBGadget()\Object\Argument))\Object\Argument$ = ParentClass$+"_"+ParsePBGadget()\Class\Argument$
          ...
          For i=0 To CountGadgetItems(Gadget)-1
            If ParsePBGadget()\Object\Argument=GetGadgetItemData(Gadget, i) 
              SetGadgetItemText(Gadget, i, ParsePBGadget()\Object\Argument$)
              Break
            EndIf
          Next 
        EndIf
...
Procedure WE_OpenWindow(Flag.i=#PB_Window_SystemMenu, ParentID=0)
  If Not IsWindow(WE)
    ...
    HideWindow(WE_Code_Open(WindowID(WE)), #True)
    ...
    WE_Splitter_0 = SplitterGadget(#PB_Any, 5, 5, 320-10, 600-MenuHeight()-10, WE_Selecting, WE_Panel_0, #PB_Splitter_FirstFixed)
  ...
  Select Event
    Case #PB_Event_Gadget ;- Gadget()
      Select EventGadget()
        ...
        Case Properties_Flag ;- Event(_Properties_Flag_)
          ...
          Select EventType()
            Case #PB_EventType_LostFocus   
              PushListPosition(ParsePBGadget())
              ForEach ParsePBGadget()
                If ParsePBGadget()\Object\Argument$ = GetGadgetText(WE_Selecting)
        ...
        Case WE_Selecting ;- Event(_WE_Selecting_)
          ...
          Select EventType()
            ...
            Case #PB_EventType_Change     
              ...
              With ParsePBGadget()
                ForEach ParsePBGadget()
                  If GetGadgetText(WE_Selecting) = \Object\Argument$
                    Properties::Init(\Object\Argument, \Object\Argument$, \Flag\Argument$)
