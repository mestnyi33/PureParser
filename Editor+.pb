...
Procedure CO_Insert(*ThisParse.ParseStruct, Parent)
  ...
  With *ThisParse
    ...
    *This\get(*This\Window\Argument$)\Code("Code_Global")\Position + VariableLength
    ...
    Select \Type\Argument$
        Case "OpenWindow", "WindowGadget"          : \Content\String$ = Handle$+"OpenWindow("+ID$+", "+\X\Argument$+", "+\Y\Argument$+", "+\Width\Argument$+", "+\Height\Argument$+", "+ Chr(34)+\Caption\Argument$+Chr(34)                            : If \Flag\Argument$ : \Content\String$ +", "+\Flag\Argument$ : EndIf: If \Param1\Argument$ : \Content\String$ +", "+\Param1\Argument$ : EndIf
  ...
  With *This
    ...
    Select \Type\Argument$
      Case "WindowGadget"          : \Type\Argument =- 1  : \Window\Argument =- 1  
        ...
        ;\Object\Argument = CanvasGadget        (#PB_Any, \X\Argument,\Y\Argument,\Width\Argument,\Height\Argument, #PB_Canvas_Container) 
        \Object\Argument = WindowGadget(#PB_Any, \X\Argument,\Y\Argument,\Width\Argument,\Height\Argument, \Caption\Argument$) 
