...
Procedure OpenFrmHaubtFenster(x = 0, y = 0, width = 270, height = 45)
  OpenWindow          (#FrmHaubtFenster, 630, 390, 270, 45, "Haubtfenster", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)                                                                                                                    
  ButtonGadget        (#FrmHauptfensterInfo, 20, 10, 123, 31, "Info", #PB_Button_Right | #PB_Button_Left)                                                                                               
  SetGadgetFont(#FrmHauptfensterInfo, FontID(#Font_FrmHaubtFenster_0))
  ButtonGadget        (#FrmHaubtfensterEnde, 150, 10, 110, 30, "Ende")                                                            
