...
Procedure W_SH_Load(Array GadgetArray.s(1))
  ...
  For i=0 To a
    If GadgetArray(i)
      AddGadgetItem(G_SH_ComboBox_G1,-1,GadgetArray(i))
      AddGadgetItem(G_SH_ComboBox_G2,-1,GadgetArray(i))
    EndIf
  Next
  ...
  For i = a+b To a+33
    AddGadgetItem(G_SH_ComboBox_G1,-1,GadgetName(i-a))
    AddGadgetItem(G_SH_ComboBox_G2,-1,GadgetName(i-a))
  Next
EndProcedure
...
Procedure W_SH_Open(ParentID.i=0, Flag.i=#PB_Window_TitleBar|#PB_Window_SizeGadget|#PB_Window_ScreenCentered)
  ...
  W_SH = OpenWindow(#PB_Any, 570, 320, 286, 206, "SplitterHelper", Flag, ParentID)
  WindowBounds(W_SH, 185,WindowHeight(W_SH),700,WindowHeight(W_SH))
  G_SH_Text_G1 = TextGadget(#PB_Any, 10, 15, 61, 16, "Gadget_1:", #PB_Text_Right)                                                                                                                                                                                                                                                                                   
  G_SH_Text_G2 = TextGadget(#PB_Any, 10, 40, 61, 16, "Gadget_2:", #PB_Text_Right)                                                                                                                                                                                                                                                                                   
  G_SH_ComboBox_G1 = ComboBoxGadget(#PB_Any, 75, 10, 281, 21)
  G_SH_ComboBox_G2 = ComboBoxGadget(#PB_Any, 75, 35, 281, 21)
  G_SH_ListIcon_Flag = ListIconGadget(#PB_Any, 10, 65, 366, 101, "Flags", 362, #PB_ListIcon_CheckBoxes)               
  AddGadgetItem(G_SH_ListIcon_Flag, #PB_Any, "#PB_Splitter_Vertical" )
  AddGadgetItem(G_SH_ListIcon_Flag, #PB_Any, "#PB_Splitter_Separator" )
  AddGadgetItem(G_SH_ListIcon_Flag, #PB_Any, "#PB_Splitter_FirstFixed" )
  AddGadgetItem(G_SH_ListIcon_Flag, #PB_Any, "#PB_Splitter_SecondFixed" )
  G_SH_Container_Line = ContainerGadget(#PB_Any, 10, 170, 366, 1, #PB_Container_Flat)  
  CloseGadgetList()
  G_SH_Button_Cancel = ButtonGadget(#PB_Any, 10, 175, 81, 21, "Cancel")   
  G_SH_Button_Ok = ButtonGadget(#PB_Any, 295, 175, 81, 21, "Ok")      
  DisableGadget(G_SH_Button_Ok, #True)
...
Procedure W_SH_Events(Event)
  ...
  Select Event
    Case #PB_Event_SizeWindow
      ResizeGadget(G_SH_Button_Ok, WindowWidth(EventWindow())-GadgetWidth(G_SH_Button_Ok)-10, #PB_Ignore, #PB_Ignore, #PB_Ignore)
      ResizeGadget(G_SH_ComboBox_G1, #PB_Ignore, #PB_Ignore, WindowWidth(EventWindow())-GadgetX(G_SH_ComboBox_G1)-10, #PB_Ignore)
      ResizeGadget(G_SH_ComboBox_G2, #PB_Ignore, #PB_Ignore, WindowWidth(EventWindow())-GadgetX(G_SH_ComboBox_G2)-10, #PB_Ignore)
      ResizeGadget(G_SH_ListIcon_Flag, #PB_Ignore, #PB_Ignore, WindowWidth(EventWindow())-GadgetX(G_SH_ListIcon_Flag)-10, #PB_Ignore)
      ResizeGadget(G_SH_Container_Line, #PB_Ignore, #PB_Ignore, WindowWidth(EventWindow())-GadgetX(G_SH_Container_Line)-10, #PB_Ignore)
      SetGadgetItemAttribute(G_SH_ListIcon_Flag, 0, #PB_ListIcon_ColumnWidth, GadgetWidth(G_SH_ListIcon_Flag)-4)
      ...
      Select EventType()
        Case #PB_EventType_Change
          Select EventGadget()
            Case G_SH_ComboBox_G1, G_SH_ComboBox_G2
              ...
              If GetGadgetText(G_SH_ComboBox_G1) And GetGadgetText(G_SH_ComboBox_G2)
                DisableGadget(G_SH_Button_Ok, #False)
              Else
                DisableGadget(G_SH_Button_Ok, #True)
              EndIf
        ...
        Case #PB_EventType_LeftClick
          Select EventGadget()
            ...
            Case G_SH_Button_Ok
              Result$ = GetGadgetText(G_SH_ComboBox_G1)+"|"+GetGadgetText(G_SH_ComboBox_G2)+"&"
              
              For i=0 To CountGadgetItems(G_SH_ListIcon_Flag)-1
                If GetGadgetItemState(G_SH_ListIcon_Flag, i) & #PB_ListIcon_Checked  
                  Result$ + GetGadgetItemText(G_SH_ListIcon_Flag, i) + "|"
                EndIf
              Next
