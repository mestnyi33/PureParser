...
Procedure CO_Open() ; Ok
  ...
  With ParsePBObject()
    \Type\Argument$ = *This\Type\Argument$
        ...
        \X\Argument = *This\X\Argument
        \Y\Argument = *This\Y\Argument
        \Width\Argument = *This\Width\Argument
        \Height\Argument = *This\Height\Argument
        \Caption\Argument$ = *This\Caption\Argument$
        \Flag\Argument = *This\Flag\Argument
      ...
      Case "OpenWindow" : \Type\Argument =- 1  : \Window\Argument =- 1  
        If IsGadget(WE_ScrollArea_0)
          Select GadgetType(WE_ScrollArea_0)
            ...
            Case #PB_GadgetType_MDI ; , \Flag\Argument, \Param1\Argument)
                                    ;\Parent\Argument = WE_ScrollArea_0
              \Object\Argument = AddGadgetItem(WE_ScrollArea_0, #PB_Any, \Caption\Argument$, SetIcon::PngToIco(ImageID(img_ico)), \Flag\Argument);|#PB_Window_NoGadgets) 
              ResizeWindow(\Object\Argument, \X\Argument,\Y\Argument,\Width\Argument,\Height\Argument)
          EndSelect
        Else
        ...
        If (\Flag\Argument&#PB_Window_NoGadgets)=0
          ParsePBObject()\UseList\Argument = \UseList\Argument
          ParsePBObject()\UseList\Argument$ = \UseList\Argument$
          \UseList\Argument = \Object\Argument
          \UseList\Argument$ = \Object\Argument$
        EndIf
    ...
    *This\Parent\Argument = \Parent\Argument
    *This\Window\Argument = \Window\Argument
  ...
  With *This
    ...
    If Bool(IsGadget(\Object\Argument) | IsWindow(\Object\Argument))
      ...
      If Not FindMapElement(\get(), Str(\Parent\Argument))
        ...
        \get()\Count+1 
      Else
        \get(Str(\Parent\Argument))\Count+1 
      EndIf
    ...
    ; 
    Select \Type\Argument$
      Case "WindowGadget" : \Window\Argument = EventWindow() : \Parent\Argument$ = \Object\Argument$ : \Parent\Argument = \Object\Argument : \Container = \Type\Argument : \SubLevel = 1
      Case "OpenWindow" : \Window\Argument = \Object\Argument : \Window\Argument$ = \Object\Argument$ : \Parent\Argument$ = \Object\Argument$ : \Parent\Argument = \Object\Argument : \Container = \Type\Argument : \SubLevel = 1
      Case "ContainerGadget", "ScrollAreaGadget" : \Parent\Argument$ = \Object\Argument$ : \Parent\Argument = \Object\Argument : \Container = \Type\Argument : \SubLevel + 1
      Case "PanelGadget" : \Parent\Argument$ = \Object\Argument$ : \Parent\Argument = \Object\Argument : \Container = \Type\Argument : \SubLevel + 1 
    ...
    ;
    If \Object\Argument And IsGadget(\Object\Argument)
...
Procedure ___ParsePBFile(FileName.s)
  ...
  If ReadFile(#File, FileName)
    ...
    If *File 
      ...
      *This\Content\Text$ = PeekS(*File, Lof, Format)
      
      RegExID = CreateRegularExpression(#PB_Any, "(?P<Comments>;).*|(?:(?P<Handle>[^:\n\s]+)\s*=\s*\b)?(?:\b(?P<Procedure>Procedure[.A-Za-z]*\b)\s*\b)?(?:\w+\s*=\s*"+~"\".*\""+"|(?P<Function>\w*)\s*\((?P<Arguments>(?>[^()]|(?R))*)\))|(?P<EndProcedure>\bEndProcedure\b)", #PB_RegularExpression_Extended )
      If RegExID
        Protected Procedure_Function.s, Procedure_Position.i, Procedure_Length.i
        
        If ExamineRegularExpression(RegExID, *This\Content\Text$)
          While NextRegularExpressionMatch(RegExID)
            If RegularExpressionNamedGroup(RegExID, "Comments") : Continue : EndIf
            
            If RegularExpressionNamedGroup(RegExID, "Procedure")
              Procedure_Function = RegularExpressionNamedGroup(RegExID, "Function")
              Procedure_Position = RegularExpressionMatchPosition(RegExID)
            EndIf
            
            ;RegularExpressionNamedGroup(RegExID, "Arguments")
            Select RegularExpressionNamedGroup(RegExID, "Function")
              Case "OpenWindow", 
                   "ButtonGadget","StringGadget","TextGadget","CheckBoxGadget",
                   "OptionGadget","ListViewGadget","FrameGadget","ComboBoxGadget",
                   "ImageGadget","HyperLinkGadget","ContainerGadget","ListIconGadget",
                ...
                ParsePBObject()\Type\DefArgument$ = Procedure_Function
                ParsePBObject()\Type\Argument$ = RegularExpressionNamedGroup(RegExID, "Function")
                ParsePBObject()\Content\String$ = RegularExpressionMatchString(RegExID)
                ParsePBObject()\Content\Length = RegularExpressionMatchLength(RegExID)
                ParsePBObject()\Content\Position = RegularExpressionMatchPosition(RegExID)
                ParsePBObject()\Argument\Argument$ = RegularExpressionNamedGroup(RegExID, "Argument")
                
              Default
                If RegularExpressionNamedGroup(RegExID, "Function")
                  AddElement(ParsePBFunc()) 
                  ParsePBFunc()\Type\DefArgument$ = Procedure_Function
                  ParsePBFunc()\Type\Argument$ = RegularExpressionNamedGroup(RegExID, "Function")
                  ParsePBFunc()\Content\String$ = RegularExpressionMatchString(RegExID)
                  ParsePBFunc()\Content\Length = RegularExpressionMatchLength(RegExID)
                  ParsePBFunc()\Content\Position = RegularExpressionMatchPosition(RegExID)
                  ParsePBFunc()\Argument\Argument$ = RegularExpressionNamedGroup(RegExID, "Argument")
              EndIf
            EndSelect
            
            If RegularExpressionNamedGroup(RegExID, "EndProcedure")
              Procedure_Length = RegularExpressionMatchPosition(RegExID)-Procedure_Position
              Procedure_Function = ""
            EndIf
  ...
  Protected Index, Arg$, Args$
  
  With *This
    ForEach ParsePBObject()
      If ParsePBObject()\Class\Argument 
        \Type\Argument$=ParsePBObject()\Type\Argument$
        \Args$=Trim(ParsePBObject()\Argument\Argument$)
