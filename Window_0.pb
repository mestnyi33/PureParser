...
Procedure Window_0_Open(Flag.i=#PB_Window_SystemMenu|#PB_Window_ScreenCentered)
  If Not IsWindow(Window_0)
    Window_0 = OpenWindow(#PB_Any,230,230,200,260,"Window_0", Flag)
    ...
    ButtonGadget(#Window_0_Button_0, 20, 10, 105, 30, Str($BD)+" Button_0", #PB_Button_Right)
    ...
    StringGadget(#Window_0_String_0, 10, 10, 100, 30, "String_0")
